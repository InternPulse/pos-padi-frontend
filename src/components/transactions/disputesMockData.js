...
export function transformDispute(dispute){
  return {
    ...
    agent: dispute.transaction.agent_id || (dispute.transaction.agent.first_name + ' ' + dispute.transaction.agent.last_name),
    amount: dispute.transaction.amount,
    customer: dispute.transaction.customer_id || (dispute.transaction.customer.first_name + ' ' + dispute.transaction.customer.last_name),
